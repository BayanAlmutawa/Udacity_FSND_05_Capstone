...
# ----------------------
    ...
    # test to get all movies without passing any token
...
# ----------------------
    ...
    # test to get all actors without passing any token
...
# POST MOVIES:
# ----------------------
    # test to post a new movie without passing any token
    ...
    # test to post a new movie by Assistant role which is not allowed
    ...
    # test to post a new movie by Executive role
    ...
    # test to post a new movie by Executive role without passing any data
...
# ----------------------
    ...
    # test to post a new actor without passing any token
    ...
    # test to post a new actor by Director role
    ...
    # test to post a new actor by Director role without passing any data
...
# ----------------------
    ...
    # test to delete a movie without passing any token
    ...
    # test to delete a movie by Director role which is not allowed
    ...
    # test to delete a movie by Executive role
    ...
    # test to delete a movie by Executive role but the movie is not exist
...
# ----------------------
    ...
    # test to delete an actor without passing any token
    ...
    # test to delete an actor by Director role
    ...
    # test to delete an actor by Director role but the actor is not exist
...
# ----------------------
    ...
    # test to patch a movie without passing any token
    ...
    # test to patch an actor by Director role
    ...
    # test to patch a movie by Director role without passing any data
    ...
    # test to patch a movie by Director role but the movie is not exist
...
# ----------------------
    ...
    # test to patch an actor without passing any token
    ...
    # test to patch an actor by Executive role
    ...
    # test to patch an actor by Executive role without passing any data
    ...
    # test to patch an actor by Executive role but the actor is not exist
